      ...
      <div className="grid md:grid-cols-2 gap-8 mt-6">
        <div>
          ...
          <p className="font-serif text-lg leading-relaxed mb-4">
            ...
            for various projects in financial technology, machine learning, and web development.
          </p>
          <p className="font-serif leading-relaxed mb-4">
            The portfolio, which leverages cutting-edge frontend technologies including real-time updates and LLM
            capabilities, demonstrates his background in software engineering, fundamental finance, and product management.
          </p>
          <p className="font-serif leading-relaxed">
            Kevin is seeking opportunities to apply his skills with leading technology companies and impactful projects,
            particularly in areas like fintech, machine learning, and data science.
          </p>
          {/* <div className="mt-4">
